...
public class Logger {
    public void error(String message, Token location) {
        log.log(Level.WARNING, message + (location != null ? " [" + location.getLine() + ":" + location.getCharPositionInLine() + "]" : ""));
    }
    ...
    public void info(String message, Token location) {
        log.log(Level.INFO, message + (location != null ? " [" + location.getLine() + ":" + location.getCharPositionInLine() + "]" : ""));
    }
