...
public class DSLFunctionSinZ extends DSLFunction {
	public DSLFunctionSinZ(DSLToken token, DSLExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return funcSin(context.getNumber(numberIndex), arguments[0].evaluate(context, scope));
	}
