...
public class CompiledLogicOperatorGreater extends CompiledCondition {
	private final CompiledExpression[] operands;
	
	public CompiledLogicOperatorGreater(ExpressionCompilerContext context, CompiledExpression[] operands, Token location) {
		super(location);
