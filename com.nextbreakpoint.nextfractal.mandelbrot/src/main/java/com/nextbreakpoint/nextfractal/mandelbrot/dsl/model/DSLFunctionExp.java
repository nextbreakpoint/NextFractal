...
public class DSLFunctionExp extends DSLFunction {
	public DSLFunctionExp(DSLToken token, DSLExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return context.getNumber(numberIndex).set(funcExp(arguments[0].evaluateReal(context, scope)));
	}
