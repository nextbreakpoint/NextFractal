...
public class DSLFunctionCos extends DSLFunction {
	public DSLFunctionCos(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexFunctionOneArgument(location, context, scope, "funcCos", arguments, numberIndex);
	}
}
