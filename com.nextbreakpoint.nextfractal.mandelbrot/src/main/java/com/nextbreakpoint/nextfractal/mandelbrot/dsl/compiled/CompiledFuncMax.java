...
public class CompiledFuncMax extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncMax(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
