...
public class CompiledOperatorMul extends CompiledExpression {
	private final CompiledExpression exp1;
	private final CompiledExpression exp2;
	
	public CompiledOperatorMul(ExpressionCompilerContext context, CompiledExpression exp1, CompiledExpression exp2, Token location) {
