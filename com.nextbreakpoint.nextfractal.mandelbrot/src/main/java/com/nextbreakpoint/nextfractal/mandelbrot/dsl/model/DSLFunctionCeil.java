...
public class DSLFunctionCeil extends DSLFunction {
	public DSLFunctionCeil(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionOneArgument(location, context, scope, "funcCeil", arguments);
	}
}
