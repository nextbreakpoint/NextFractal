...
public class CompiledFuncSquare extends CompiledExpression {
	private final CompiledExpression[] arguments;

	public CompiledFuncSquare(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
	...
	public Number evaluate(ExpressionContext context, Map<String, Variable> scope) {
		return context.getNumber(index).set(funcSquare(arguments[0].evaluateReal(context, scope)));
	}
