...
public class CompiledFuncPow extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncPow(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
