...
public class DSLTrapOpArcRel extends DSLTrapOp {
	public DSLTrapOpArcRel(DSLToken token, ComplexNumber c1, ComplexNumber c2) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		CompilerUtils.compileTrapOp(context, "arcRel", c1, c2);
	}
}
