...
public class CompiledFuncSin extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncSin(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
