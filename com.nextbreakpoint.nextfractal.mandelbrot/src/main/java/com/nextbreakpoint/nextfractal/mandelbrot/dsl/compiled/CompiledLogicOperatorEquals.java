...
public class CompiledLogicOperatorEquals extends CompiledCondition {
	private final CompiledExpression[] operands;
	
	public CompiledLogicOperatorEquals(ExpressionCompilerContext context, CompiledExpression[] operands, Token location) {
		super(location);
