...
public class CompiledFuncCosZ extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncCosZ(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
