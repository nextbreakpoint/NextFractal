...
public class CompiledFuncImZ extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncImZ(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
