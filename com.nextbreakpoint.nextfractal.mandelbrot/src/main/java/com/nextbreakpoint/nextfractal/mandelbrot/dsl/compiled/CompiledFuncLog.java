...
public class CompiledFuncLog extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncLog(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
