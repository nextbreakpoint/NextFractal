...
public class DSLFunctionHypot extends DSLFunction {
	public DSLFunctionHypot(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionTwoArguments(location, context, scope, "funcHypot", arguments);
	}
}
