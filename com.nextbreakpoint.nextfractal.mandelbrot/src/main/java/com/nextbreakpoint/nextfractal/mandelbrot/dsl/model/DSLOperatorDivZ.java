...
public class DSLOperatorDivZ extends DSLOperator {
	public DSLOperatorDivZ(Token location, DSLExpression exp1, DSLExpression exp2, int numberIndex) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexMathOperator(context, scope, "opDiv", exp1, exp2, numberIndex);
	}
}
