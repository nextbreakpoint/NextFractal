...
public class CompiledConditionalExpression extends CompiledExpression {
	...
	private final CompiledExpression thenExp;
	private final CompiledExpression elseExp;
	
	public CompiledConditionalExpression(ExpressionCompilerContext context, CompiledCondition condition, CompiledExpression thenExp, CompiledExpression elseExp, Token location) {
