...
public class CompiledLogicOperatorGreather extends CompiledCondition {
	private CompiledExpression[] operands;
	
	public CompiledLogicOperatorGreather(ExpressionContext context, CompiledExpression[] operands, Token location) {
		super(location);
