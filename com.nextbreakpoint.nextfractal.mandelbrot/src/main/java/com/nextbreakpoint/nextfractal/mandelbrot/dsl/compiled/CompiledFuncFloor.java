...
public class CompiledFuncFloor extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncFloor(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
