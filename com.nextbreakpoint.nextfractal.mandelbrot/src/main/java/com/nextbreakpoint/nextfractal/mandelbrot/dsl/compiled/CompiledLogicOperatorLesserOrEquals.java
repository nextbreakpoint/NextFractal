...
public class CompiledLogicOperatorLesserOrEquals extends CompiledCondition {
	private final CompiledExpression[] operands;
	
	public CompiledLogicOperatorLesserOrEquals(ExpressionCompilerContext context, CompiledExpression[] operands, Token location) {
		super(location);
