...
public class CompiledFuncMod2 extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncMod2(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
