...
public class CompiledTrapOpArcRel extends CompiledTrapOp {
	private final Number c1;
	private final Number c2;

	public CompiledTrapOpArcRel(Number c1, Number c2, Token location) {
		super(location);
		this.c1 = c1;
		this.c2 = c2;
	}
