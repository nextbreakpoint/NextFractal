...
public class DSLFunctionAcos extends DSLFunction {
	public DSLFunctionAcos(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexFunctionOneArgument(location, context, scope, "funcAcos", arguments, numberIndex);
	}
}
