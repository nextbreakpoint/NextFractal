...
public class ASTException extends RuntimeException {
	private final DSLToken location;

	public ASTException(String message, DSLToken location, Throwable cause) {
		super(message, cause);
		this.location = location;
	}

	public ASTException(String message, DSLToken location) {
		super(message);
		this.location = location;
	}
