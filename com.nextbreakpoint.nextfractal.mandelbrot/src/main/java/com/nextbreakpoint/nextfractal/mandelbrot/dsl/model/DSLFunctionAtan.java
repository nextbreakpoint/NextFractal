...
public class DSLFunctionAtan extends DSLFunction {
	public DSLFunctionAtan(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexFunctionOneArgument(location, context, scope, "funcAtan", arguments, numberIndex);
	}
}
