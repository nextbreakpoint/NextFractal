...
public class CompiledPaletteExpression extends CompiledColorExpression {
	...
	public CompiledPaletteExpression(String name, CompiledExpression exp, Token location) {
		super(location);
		this.name = name;
		this.exp = exp;
	}

	public float[] evaluate(ExpressionContext context, Map<String, Variable> scope) {
