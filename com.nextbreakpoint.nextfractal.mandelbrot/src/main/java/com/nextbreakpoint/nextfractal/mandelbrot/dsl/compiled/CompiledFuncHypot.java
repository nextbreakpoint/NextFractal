...
public class CompiledFuncHypot extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncHypot(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
