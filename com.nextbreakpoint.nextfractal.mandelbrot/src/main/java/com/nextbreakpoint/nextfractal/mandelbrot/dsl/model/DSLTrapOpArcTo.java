...
public class DSLTrapOpArcTo extends DSLTrapOp {
	public DSLTrapOpArcTo(DSLToken token, ComplexNumber c1, ComplexNumber c2) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		CompilerUtils.compileTrapOp(context, "arcTo", c1, c2);
	}
}
