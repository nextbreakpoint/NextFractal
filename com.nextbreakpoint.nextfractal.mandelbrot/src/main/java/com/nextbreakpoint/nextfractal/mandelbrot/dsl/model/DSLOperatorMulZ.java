...
public class DSLOperatorMulZ extends DSLOperator {
	public DSLOperatorMulZ(Token location, DSLExpression exp1, DSLExpression exp2, int numberIndex) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexMathOperator(context, scope, "opMul", exp1, exp2, numberIndex);
	}
}
