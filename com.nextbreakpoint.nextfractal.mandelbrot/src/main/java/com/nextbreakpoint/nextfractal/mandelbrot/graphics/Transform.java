...
public class Transform {
	...
	private Transform(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22) {
	...
	public static Transform newScale(double sx, double sy) {
		return new Transform(sx, 0, 0, 0, sy, 0, 0, 0, 1);
	}
	
	public static Transform newRotate(double rz) {
