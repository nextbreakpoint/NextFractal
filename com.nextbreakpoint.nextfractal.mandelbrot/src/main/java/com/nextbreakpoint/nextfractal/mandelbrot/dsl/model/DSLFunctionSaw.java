...
public class DSLFunctionSaw extends DSLFunction {
	public DSLFunctionSaw(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionOneArgument(location, context, scope, "funcSaw", arguments);
	}
}
