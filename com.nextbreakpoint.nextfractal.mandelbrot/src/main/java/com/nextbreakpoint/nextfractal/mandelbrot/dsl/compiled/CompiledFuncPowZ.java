...
public class CompiledFuncPowZ extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncPowZ(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
