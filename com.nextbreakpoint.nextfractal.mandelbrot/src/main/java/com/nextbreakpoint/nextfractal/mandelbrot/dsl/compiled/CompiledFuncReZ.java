...
public class CompiledFuncReZ extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncReZ(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
