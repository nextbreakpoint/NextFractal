...
public class DSLFunctionImZ extends DSLFunction {
	public DSLFunctionImZ(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexFunctionOneComplexArgument(location, context, scope, "funcIm", arguments);
	}
}
