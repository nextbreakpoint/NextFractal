...
public class DSLFunctionModZ extends DSLFunction {
	public DSLFunctionModZ(DSLToken token, DSLExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return context.getNumber(numberIndex).set(funcMod(arguments[0].evaluate(context, scope)));
	}
