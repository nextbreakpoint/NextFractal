...
public class CompiledFuncTanZ extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncTanZ(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
