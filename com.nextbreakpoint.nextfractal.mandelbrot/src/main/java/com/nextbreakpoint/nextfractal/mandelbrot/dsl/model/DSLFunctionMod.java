...
public class DSLFunctionMod extends DSLFunction {
	public DSLFunctionMod(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileComplexFunctionOneComplexArgument(location, context, scope, "funcMod", arguments);
	}
}
