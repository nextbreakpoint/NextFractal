...
public class DSLFunctionCosZ extends DSLFunction {
	public DSLFunctionCosZ(DSLToken token, DSLExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return funcCos(context.getNumber(numberIndex), arguments[0].evaluate(context, scope));
	}
