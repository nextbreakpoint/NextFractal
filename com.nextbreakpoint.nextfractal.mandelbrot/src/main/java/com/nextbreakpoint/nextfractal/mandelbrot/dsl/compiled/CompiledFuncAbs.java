...
public class CompiledFuncAbs extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncAbs(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
