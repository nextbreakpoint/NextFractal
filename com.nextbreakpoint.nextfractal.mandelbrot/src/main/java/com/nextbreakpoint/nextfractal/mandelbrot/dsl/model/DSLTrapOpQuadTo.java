...
public class DSLTrapOpQuadTo extends DSLTrapOp {
	public DSLTrapOpQuadTo(DSLToken token, ComplexNumber c1, ComplexNumber c2) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		CompilerUtils.compileTrapOp(context, "quadTo", c1, c2);
	}
}
