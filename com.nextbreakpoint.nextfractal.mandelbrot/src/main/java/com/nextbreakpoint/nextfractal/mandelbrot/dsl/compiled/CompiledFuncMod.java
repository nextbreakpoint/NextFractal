...
public class CompiledFuncMod extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncMod(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
