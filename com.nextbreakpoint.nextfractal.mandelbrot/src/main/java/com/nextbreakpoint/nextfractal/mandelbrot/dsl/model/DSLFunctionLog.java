...
public class DSLFunctionLog extends DSLFunction {
	public DSLFunctionLog(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionOneArgument(location, context, scope, "funcLog", arguments);
	}
}
