...
public class CompiledFuncCeil extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncCeil(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
