...
public class CompiledFuncCos extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncCos(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
	...
	public Number evaluate(ExpressionContext context, Map<String, Variable> scope) {
		return context.getNumber(index).set(funcCos(arguments[0].evaluateReal(context, scope)));
	}
