...
public class DSLFunctionAtan2 extends DSLFunction {
	public DSLFunctionAtan2(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionTwoArguments(location, context, scope, "funcAtan2", arguments);
	}
}
