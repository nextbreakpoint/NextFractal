...
public class DSLTrapOpCurveTo extends DSLTrapOp {
	public DSLTrapOpCurveTo(DSLToken token, ComplexNumber c1, ComplexNumber c2, ComplexNumber c3) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		CompilerUtils.compileTrapOp(context, "curveTo", c1, c2, c3);
	}
}
