...
public class DSLFunctionFloor extends DSLFunction {
	public DSLFunctionFloor(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public void compile(DSLCompilerContext context, Map<String, VariableDeclaration> scope) {
		DSLUtils.compileRealFunctionOneArgument(location, context, scope, "funcFloor", arguments);
	}
}
