...
public class DSLOperatorPowZ extends DSLOperator {
	public DSLOperatorPowZ(DSLToken token, DSLExpression exp1, DSLExpression exp2, int numberIndex) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return opPow(context.getNumber(numberIndex), exp1.evaluate(context, scope), exp2.evaluateReal(context, scope));
	}
