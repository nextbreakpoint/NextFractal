...
public class CompiledFuncMin extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncMin(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
