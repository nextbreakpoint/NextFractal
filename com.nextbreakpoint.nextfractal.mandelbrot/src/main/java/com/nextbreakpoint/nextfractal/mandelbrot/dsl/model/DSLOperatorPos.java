...
public class DSLOperatorPos extends DSLOperator {
	public DSLOperatorPos(Token location, DSLExpression exp, int numberIndex) {
		super(location, exp, null, numberIndex);
	}
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return opPos(context.getNumber(numberIndex), exp1.evaluate(context, scope));
	}
