...
public class CompiledLogicOperatorAnd extends CompiledCondition {
	private final CompiledCondition[] operands;
	
	public CompiledLogicOperatorAnd(ExpressionCompilerContext context, CompiledCondition[] operands, Token location) {
		super(location);
