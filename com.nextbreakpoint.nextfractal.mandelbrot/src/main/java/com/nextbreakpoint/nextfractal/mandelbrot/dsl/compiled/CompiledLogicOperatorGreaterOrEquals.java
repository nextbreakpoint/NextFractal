...
public class CompiledLogicOperatorGreaterOrEquals extends CompiledCondition {
	private final CompiledExpression[] operands;
	
	public CompiledLogicOperatorGreaterOrEquals(ExpressionCompilerContext context, CompiledExpression[] operands, Token location) {
		super(location);
		this.operands = operands;
	}

	@Override
	public boolean evaluate(ExpressionContext context, Map<String, Variable> scope) {
