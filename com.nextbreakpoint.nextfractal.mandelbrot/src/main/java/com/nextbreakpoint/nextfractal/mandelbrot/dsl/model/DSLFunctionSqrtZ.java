...
public class DSLFunctionSqrtZ extends DSLFunction {
	public DSLFunctionSqrtZ(Token location, ExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return funcSqrt(context.getNumber(numberIndex), arguments[0].evaluate(context, scope));
	}
