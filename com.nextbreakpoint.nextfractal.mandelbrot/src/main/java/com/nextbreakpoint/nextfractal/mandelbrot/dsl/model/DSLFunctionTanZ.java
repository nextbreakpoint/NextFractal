...
public class DSLFunctionTanZ extends DSLFunction {
	public DSLFunctionTanZ(DSLToken token, DSLExpressionContext context, DSLExpression[] arguments) {
	...
	public ComplexNumber evaluate(DSLInterpreterContext context, Map<String, Variable> scope) {
		return funcTan(context.getNumber(numberIndex), arguments[0].evaluate(context, scope));
	}
