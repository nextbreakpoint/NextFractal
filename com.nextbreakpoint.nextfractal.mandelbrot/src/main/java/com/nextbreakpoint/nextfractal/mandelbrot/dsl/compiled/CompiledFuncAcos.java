...
public class CompiledFuncAcos extends CompiledExpression {
	private final CompiledExpression[] arguments;

	public CompiledFuncAcos(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
	...
	public Number evaluate(ExpressionContext context, Map<String, Variable> scope) {
		return context.getNumber(index).set(funcAcos(arguments[0].evaluateReal(context, scope)));
	}
