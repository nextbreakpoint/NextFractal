...
public class CompiledFuncModZ2 extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncModZ2(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
