...
public class CompiledFuncPulse extends CompiledExpression {
	private final CompiledExpression[] arguments;

	public CompiledFuncPulse(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
	...
	public Number evaluate(ExpressionContext context, Map<String, Variable> scope) {
		return context.getNumber(index).set(funcPulse(arguments[0].evaluateReal(context, scope), arguments[1].evaluateReal(context, scope)));
	}
