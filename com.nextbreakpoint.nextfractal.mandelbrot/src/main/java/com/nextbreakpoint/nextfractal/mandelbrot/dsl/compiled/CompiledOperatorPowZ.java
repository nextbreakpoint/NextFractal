...
public class CompiledOperatorPowZ extends CompiledExpression {
	private final CompiledExpression exp1;
	private final CompiledExpression exp2;
	
	public CompiledOperatorPowZ(ExpressionCompilerContext context, CompiledExpression exp1, CompiledExpression exp2, Token location) {
