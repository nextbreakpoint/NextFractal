...
public class CompiledFuncTan extends CompiledExpression {
	private final CompiledExpression[] arguments;
	
	public CompiledFuncTan(ExpressionCompilerContext context, CompiledExpression[] arguments, Token location) {
